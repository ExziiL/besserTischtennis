...
import GioeleBild2 from '../../../css/pictures/Gioele_Bild_2.jpg';
...
const AboutMe: FC<IAboutMe> = ({ idName }) => {
	...
	return (
		<section ref={aboutMeRef} className="p-4 mt-12 mb-12 xl:px-0 md:mt-40 md:mb-20 sm:mx-0 scroll-mt-20" id={idName}>
			<h2 className="mb-8 text-4xl font-semibold md:mb-16 md:text-5xl">Das bin ich</h2>
			<div className="flex flex-col items-center md:items-start md:justify-between md:flex-row">
				<div className="flex flex-col max-w-md pb-12 md:items-start md:pb-4 md:w-1/2 ">
					...
					<div className="w-60">
						<Image src={GioeleBild2} className="rounded-2xl" />
					...
					<p className="font-semibold text-gray-500 pt-14 md:pr-8 md:text-left">
						...
						die Hand gelegt hat, ist unsere riesen Begeisterung für den Sport nie verloren gegangen. Seitdem sind wir als aktive Spieler und erfahrene Trainer im Großraum Stuttgart tätig. Über die Jahre konnten wir viele Eindrücke und Impulse in verschiedenen Lehrgängen, Trainerfortbildungen,
						Literaturen und vielem mehr sammeln. Um diese Erfahrungen zu bündeln und weiterzugeben, haben wir 2020 das Unternehmen BesserTischtennis gegründet. Heute vereinen wir auf unserer Plattform professionelles und flexibles Tischtennistraining mit innovativen Ideen, die unseren Sport
						voranbringen.
					</p>
