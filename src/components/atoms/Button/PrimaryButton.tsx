...
const PrimaryButton: FC<IPrimaryButton> = ({ name, disabled, onClick, className, ref, id }) => {
	return (
		<div className={`${className}`} ref={ref} id={id}>
			...
			<button onClick={onClick} className={`px-8 py-3 bg-[#1E1B1B] text-white rounded-lg hover:bg-[#332e2e]`} disabled={disabled} type="button">
